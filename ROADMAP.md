...
**État de `security/` au 01/08/2026 — niveau 0, observation seule.** Guardian et Privacy Shield existent en ébauche testée (47 tests) : ils détectent et rapportent, ils n'agissent jamais. Aucun process tué, aucune connexion coupée, aucun appel à un service externe. Leur donner un pouvoir d'action défensif est une décision distincte, à valider par Cyril. Prochains niveaux envisageables : détection de chiffrement massif (ransomware), suivi des hooks clavier (keylogger), historique des connexions pour repérer les anomalies dans la durée.
